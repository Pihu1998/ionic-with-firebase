...
/* harmony import */ var _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/facebook/ngx */ "GGTb");
...
let HomePage = class HomePage {
    ...
    login() {
        this.facebook.login(["email"]).then((loginResponse) => {
            let credential = firebase__WEBPACK_IMPORTED_MODULE_4__["default"].auth.FacebookAuthProvider.credential(loginResponse.authResponse.accessToken);
            firebase__WEBPACK_IMPORTED_MODULE_4__["default"].auth().signInWithRedirect(credential).then((info) => {
